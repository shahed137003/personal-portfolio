      ...
      <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start gap-60">
        ...
        >
          ...
          {[
            ...
            <motion.div
              key={index}
              className={`transition duration-300 ease-in transform hover:scale-105 w-full min-h-[60px] sm:min-h-[80px] ${item.gradient} border ${item.border} rounded-xl p-3 sm:p-4 flex items-center gap-3`}
