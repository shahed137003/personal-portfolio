...
export default function NavBar() {
  ...
  return (
    <nav className="bg-[#000000e8] backdrop-blur-md py-4 px-8 text-white border-b border-[#833CAA] fixed w-full flex items-center justify-between z-50 shadow-lg">
      ...
      <a
        href="#homeSection"
        className="text-transparent bg-clip-text bg-gradient-to-r from-[#833CAA] to-[#A044FF] text-4xl font-bold tracking-wide hover:scale-105 transition-transform duration-300"
      >
        SM
      </a>
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="absolute top-full left-0 w-full bg-[#000000f5] backdrop-blur-md border-t border-[#833CAA] md:hidden animate-slideDown">
